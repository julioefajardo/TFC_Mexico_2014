...
#define FTM1_OVERFLOW_FREQUENCY 95  // Desired Frequency of PWM Signal - Here 50Hz => 20ms period
...
{
							Position=0.0196428f*Position-0.449998f;
                              TFC_SetServoDutyCycle(ServoNumber , 
                                                            (((Position + 1.0)/2.0)*(SERVO_MAX_DUTY_CYCLE - SERVO_MIN_DUTY_CYCLE))+SERVO_MIN_DUTY_CYCLE);
